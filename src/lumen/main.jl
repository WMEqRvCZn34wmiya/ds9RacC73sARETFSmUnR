...
function lumen(
    ...
    is_minimization_scheme_espresso = minimization_scheme == :mitespresso
    ...
    if !controllo
        ...
        #= OLD CODE were we haven't Constructor
            ...
            # Results Processing
            combined_results =
                concat_results(results, num_atoms, thresholds_by_feature, atoms_by_feature)
        =#
        # Results Processing
        combined_results =
            concat_results(results, my_atoms)
        ...
        for (result, formula) in combined_results
            ...
            formula_semplificata_t = @timed minimizza_dnf(
    ...
    if controllo
        ...
        are_results_equal =
            compare_truth_combinations(modelJ, my_alphabet, my_atoms, vertical; apply_function, silent, kwargs...)
